    ...
    <div class="create-farm-head fs-container">
      <div class="btn-outline">
        <a
          ...
          target="_blank"
        >
          <Button class="link-btn textS weightS">Detailed guide</Button>
        </a>
      </div>
      <div class="btn-outline">
        <a href="https://t.me/CropperFinance" target="_blank">
          <Button class="link-btn textS weightS">Get support </Button>
        </a>
      </div>
    </div>
          ...
          >
            ...
            <Row v-if="current === 0 && wallet.connected">
              <Col :span="24" class="step-item">
                <label class="textL weightB">Farm Type:</label>
              ...
              <Col :span="24" class="step-item">
                <label class="textL weightB">Token pairing and AMM ID:</label>
                <div class="step-item-content">
                  <RadioGroup v-model="ammType" @change="selectAMM">
                    ...
                    <div class="create-amm" v-if="ammType != 1">
                      <NuxtLink to="/pools/create-pool" class="link-pool textS">
            ...
            <Row v-if="current === 1">
              <Col :span="24" class="step-item">
                <label class="textL weightB">Reward emission:</label>
                <div class="step-item-content">
                  <CoinInput
              ...
              <Col :span="24" class="step-item">
                <label class="textL weightB">Farm duration:</label>
                <div class="step-item-content">
            ...
            <Row v-if="current === 2">
              <Col :span="24" class="step-item">
                <div v-if="!isCRPTokenPair" class="farm-created">
                  <label class="textL weightB">Congratulations! Your farm has been successfully created!</label>
                </div>
                <div class="lp-icons">
                  <div class="lp-icons-group">
                    <div class="icons">
                      <CoinIcon :mint-address="tokenA.mintAddress" />
                      <span class="textS weightS">{{ tokenA.symbol }} - </span>
                      <CoinIcon :mint-address="tokenB.mintAddress" />
                      <span class="textS weightS">{{ tokenB.symbol }}</span>
                    </div>
                  </div>
                </div>
                <div class="btn-container">
