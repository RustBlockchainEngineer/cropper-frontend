              ...
              <Col class="state" span="3">
                ...
                <div v-else class="value">
                  {{ ((
                    ...
                    ) ? 0 : farm.farmInfo.reward.symbol + ' ' + (Math.round(farm.userInfo.pendingReward.format().replace(/,/g, '') * 100000) / 100000)) }}
                </div>
                ...
                <Row slot="header" class="farm-item noDesktop">
                  ...
                  <Col class="farm-mobile-section" span="24">
                    ...
                    <Col class="state" span="7">
                      ...
                      <div v-if="farm.farmInfo.poolInfo.start_timestamp > currentTimestamp" class="value">-</div>
                      <div v-else class="value">
                        {{ (!wallet.connected || (Math.round(farm.userInfo.pendingReward.format().replace(/,/g, '') * 100000) / 100000) &lt; 0) ? 0 : farm.farmInfo.reward.symbol + ' ' + (Math.round(farm.userInfo.pendingReward.format().replace(/,/g, '') * 100000) / 100000) }}
                      </div>
                    </Col>
                  </Col>
